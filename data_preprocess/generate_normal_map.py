...
from engineer.datasets.loader.build_loader import (
    train_loader_collate_fn,
    test_loader_collate_fn,
)
...
def generate(dataset):
    ...
    for i in range(0, len(dataset.subjects)):
        ...
        for j in tqdm(range(0, 360)):
            ...
            depth_path = target_mesh_path.replace("GEO/OBJ/", "RENDER_DEPTH/")
            ...
            img.save(os.path.join(depth_path, "{}_0_00.jpg".format(j)))
